...
// lighting options
#define STUDIO_NF_FLATSHADE 0b01 //0x01 - 1
#define STUDIO_NF_CHROME 0b010 // 0x02 - 2
#define STUDIO_NF_FULLBRIGHT 0b0100 // 0x04 - 4
#define STUDIO_NF_NOMIPMAPS 0b01000 // 0x08 - 8
#define STUDIO_NF_ALPHATEST 0b010000 // 0x0010 - 16
#define STUDIO_NF_ADDITIVE 0b0100000 // 0x0020 - 32
