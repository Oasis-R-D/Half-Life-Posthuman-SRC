...
#define RGB_YELLOWISH 0x00CC5500	// 204, 85, 0
#define RGB_REDISH 0x00FF1010	 	//255,160,0
#define RGB_GREENISH 0x0055CC00	 	//85, 204, 0
...
public:
	...
	void MsgFunc_CrossHair(const char* pszName, int iSize, void* pbuf);
	...
	bool MsgFunc_FlashHUD(const char* pszName, int iSize, void* pbuf);
