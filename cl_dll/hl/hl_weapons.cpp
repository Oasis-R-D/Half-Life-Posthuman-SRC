...
CHeadcrabGrenadeFast g_HeadcrabFast;
CHeadcrabGrenadePoison g_HeadcrabPoison;
...
void HUD_InitClientWeapons()
{
	...
	HUD_PrepEntity(&g_GlockDual, &player);
	...
	HUD_PrepEntity(&g_HeadcrabFast, &player);
	HUD_PrepEntity(&g_HeadcrabPoison, &player);
...
void HUD_WeaponsPostThink(local_state_s* from, local_state_s* to, usercmd_t* cmd, double time, unsigned int random_seed)
{
	...
	case WEAPON_CHAINGUN:
		pWeapon = &g_M249;
		break;
	case WEAPON_GRENADE_HEADCRAB:
		pWeapon = &g_Headcrab;
		break;
	case WEAPON_GRENADE_HEADCRAB_FAST:
		pWeapon = &g_HeadcrabFast;
		break;
	case WEAPON_GRENADE_HEADCRAB_POISON:
		pWeapon = &g_HeadcrabPoison;
		break;
	case WEAPON_SPITTHROWER:
		pWeapon = &g_SpitThrower;
		break;
	case WEAPON_EAGLE:
		pWeapon = &g_Eagle;
		break;
