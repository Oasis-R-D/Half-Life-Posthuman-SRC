...
extern int UTIL_BloodPuff(TraceResult tr, int bloodcolor);
...
extern void UTIL_DecalTrace(TraceResult* pTrace, int decalNumber, int applyradius = 0, int rot = -1);
...
extern double UTIL_Round(double roundee, int roundto);
