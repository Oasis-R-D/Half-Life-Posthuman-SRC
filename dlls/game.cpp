...
// M727
cvar_t sk_plr_m7271 = {"sk_plr_m7271", "0"};
cvar_t sk_plr_m7272 = {"sk_plr_m7272", "0"};
cvar_t sk_plr_m7273 = {"sk_plr_m7273", "0"};
...
// Elite Round
DECLARE_SKILL_CVARS(plr_10mm_bullet);
...
cvar_t sk_M727_bullet1 = {"sk_M727_bullet1", "0"};
cvar_t sk_M727_bullet2 = {"sk_M727_bullet2", "0"};
cvar_t sk_M727_bullet3 = {"sk_M727_bullet3", "0"};
...
void GameDLLInit()
{
	...
	// M727
	CVAR_REGISTER(&sk_plr_m7271);
	CVAR_REGISTER(&sk_plr_m7272);
	CVAR_REGISTER(&sk_plr_m7273);
	...
	// Elite Round
	REGISTER_SKILL_CVARS(plr_10mm_bullet);
	...
	CVAR_REGISTER(&sk_M727_bullet1); // no comments for you!!!!!
	CVAR_REGISTER(&sk_M727_bullet2); // no comments for you!!!!!
	CVAR_REGISTER(&sk_M727_bullet3); // no comments for you!!!!!
