...
#define MP5_MAX_CLIP 45
#define MP5_DEFAULT_AMMO 15
#define M727_MAX_CLIP 30
...
#define CROSSBOW_DEFAULT_GIVE 3
...
public:
	...
	bool DefaultDeploy(const char* szViewModel, const char* szWeaponModel, int iAnim, const char* szAnimExt, int body = 0, const char* szAltViewModel = nullptr, int iAltAnim = -1);
...
enum glock_e
{
	...
	GLOCK_HOLSTER,
	GLOCK_ADD_SILENCER,
	GLOCK_IDLE_TO_SPRINT,
	GLOCK_SPRINT,
	GLOCK_SPRINT_TO_IDLE,
};
...
enum shotgun_e
{
	...
	SHOTGUN_RELOAD_START_EMPTY_SEMI,
	SHOTGUN_RELOAD_INSERT,
	SHOTGUN_RELOAD_INSERT_SEMI,
	SHOTGUN_RELOAD_END,
	SHOTGUN_RELOAD_END_SEMI,
	SHOTGUN_DRAW,
	SHOTGUN_DRAW_SEMI,
	SHOTGUN_DRAW_FIRST,
	SHOTGUN_HOLSTER,
	SHOTGUN_HOLSTER_SEMI,
	SHOTGUN_PUMP_TO_SEMI,
	SHOTGUN_SEMI_TO_PUMP,
};
...
class CHeadcrabGrenadeFast : public CSqueak
{
public:
	void Spawn() override;
	int iItemSlot() override { return 5; }
...
class CHeadcrabGrenadePoison: public CSqueak
{
public:
	void Spawn() override;
	int iItemSlot() override { return 5; }
