...
enum WeaponId
{
	...
	WEAPON_SATCHEL,
	WEAPON_SNARK,
	WEAPON_GRENADE_HEADCRAB,
	WEAPON_GRENADE_HEADCRAB_FAST,
	WEAPON_GRENADE_HEADCRAB_POISON,
	WEAPON_SPITTHROWER,
	WEAPON_EAGLE,
	WEAPON_M727,
	WEAPON_M29,
...
#define DMG_FUNGUS (1 << 23)	   // Poison but different
...
#define DMG_TIMEBASED (~(0xff003fff) | DMG_FUNGUS) // mask for time-based damage

// these are the damage types that have client hud art
#define DMG_SHOWNHUD (DMG_POISON | DMG_ACID | DMG_FREEZE | DMG_SLOWFREEZE | DMG_DROWN | DMG_BURN | DMG_SLOWBURN | DMG_NERVEGAS | DMG_RADIATION | DMG_ENERGYBEAM | DMG_SHOCK | DMG_BULLET | DMG_FALL | DMG_HUNGER | DMG_PARALYZE | DMG_FUNGUS)
